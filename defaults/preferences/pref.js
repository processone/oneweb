pref("oneweb.connection.resource", "OneWeb");
pref("oneweb.connection.port", 5222);
pref("oneweb.connection.type", "native");
pref("oneweb.permissions.openedtabs", 0);
pref("oneweb.permissions.openurl", 0);
pref("oneweb.permissions.searchbookmarks", 0);
pref("oneweb.general.bookmarksSync.enabled", true);
